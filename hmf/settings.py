"""
Django settings for hmf project.
...
SECRET_KEY = 'django-insecure-h)8473-c!x3sx39061^*0t+2a2r2)0(2=n--ys(sou_&-q_k+g'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'foodapp/static')]
